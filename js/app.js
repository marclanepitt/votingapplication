$( document ).ready(function() {
	...
	if($.cookie("uuid") == null) {
		...
		$.ajax({
		  url: "https://societythinks.herokuapp.com/php/user.php/"+$.cookie("uid"),
		  method: "GET",
		  dataType: "json"
	...
	$("#change-pic-form").submit(function(e) {
		...
		$.ajax({
			  ...
			  dataType: "json"
				...
				$.ajax({
 				  url: "https://societythinks.herokuapp.com/php/user.php/update/"+$.cookie("uid"),
				  method: "POST",
				  data: {
	...
	$("#logout-btn").click(function() {
		$("#overlay").css("display","block");
		$.ajax({
		  url: "https://societythinks.herokuapp.com/php/auth.php/logout?user="+$.cookie("uid"),
		  method: "GET",
		  dataType: "json"
		}).done(function(response) {
